...
class _MemberFixtureCreationPageState extends State<MemberFixtureCreationPage> {
    ...
    try {
      ...
      final insertedRows = await _client
          ...
          .insert({
            ...
            'orientation':
                (_isOutdoorSelectedGreen && _orientationEnabledForSelectedGreen)
                ? _orientation
                : null,
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_fixtureTypeById(_fixtureTypeId)?['is_internal'] ==
                      true) ...[
                    InputDecorator(
                      decoration: const InputDecoration(
                        labelText: 'Location',
