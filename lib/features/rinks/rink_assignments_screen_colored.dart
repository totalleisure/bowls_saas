...
setState(() {
    ...
    try {
      ...
      final rinks = await client
          .from('fixture_rinks')
          .select('id, rink_order, format, players_per_rink, home_rink_label')
      ...
      rinkList.sort((a, b) {
        ...
        // otherwise sort by rink_order
        final ao = a['rink_order'] as int;
        final bo = b['rink_order'] as int;
                  ...
                  children: [
                    if (_rinks.isEmpty)
                      ...
                      ..._rinks.map((r) {
                        ...
                        final order = r['rink_order'] as int;
