...
class _MemberEditScreenState extends State<MemberEditScreen> {
  ...
  late final TextEditingController _outdoorClub;
  ...
  void initState() {
    ...
    _outdoorClub = TextEditingController(
      text: (i['outdoor_club'] ?? '').toString(),
    );
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'outdoor_club': _outdoorClub.text.trim().isEmpty
            ? null
            : _outdoorClub.text.trim(),
        'gender': _gender,
  ...
  Future<void> _openEmailAction() async {
    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'To change your email address, open Member and Volunteer Lists, '
          'then select Account and Security. Choose Change login email '
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _dropdownField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          _gender = value == null || value.isEmpty
                              ? null
                              : value;
                    ...
                    const SizedBox(height: 8),
                    _field('Outdoor club (optional)', _outdoorClub),
                    _dropdownField(
