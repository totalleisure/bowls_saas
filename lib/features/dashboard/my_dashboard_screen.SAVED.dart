    ...
    try {
      ...
      final fixtureRows = await Supabase.instance.client
          ...
          .select('''
            ...
            'home_venue:venues!fixtures_home_venue_id_fkey(name)',
            'green:greens!fixtures_green_id_fkey(name, orientation)',
            'format:match_formats!fixtures_match_format_id_fkey(label',
            players_per_rink)
          ''')
