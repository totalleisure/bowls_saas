              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _topicButton('3. Fixture Types and Workflows',
                          _fixtureTypesKey),
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('Decide which fixture types require RSVP, team selection, pre-selection or member booking.'),
                  ],
                ),
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('Enter the maximum number of rinks the green can support.'),
                    _p(
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('A league match may gather availability before a selector chooses the team.'),
                    _bullet('An internal competition may allow players to be selected directly.'),
                    _bullet('A member booked fixture may focus on booking a rink and adding the players involved.'),
                    _p(
                    ...
                    _bullet('How many rinks and players are normally required.'),
                    _bullet('Whether players RSVP or declare availability.'),
                    _bullet('Whether players are selected directly.'),
                    _bullet('Whether members can create the fixture themselves.'),
                    _bullet('Whether captains or admins manage the fixture.'),
                    _bullet('What colours are used on the dashboard and diary.'),
                  ],
                ),
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('Confirm whether RSVP, availability or direct selection is required.'),
                    _bullet('Assign a captain where possible before publishing.'),
                  ],
                ),
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('Selectors or captains choose the team from the responses.'),
                    _bullet('Selected players are then asked to accept or decline.'),
                    ...
                    _bullet('Players are selected directly by an admin, selector or captain.'),
                    _bullet('There may be no RSVP stage.'),
                    _bullet('The fixture can be published once the team or players are ready.'),
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('It can be done before exact rink numbers are known.'),
                    ...
                    _bullet('Admins may adjust rinks if green conditions or layouts change.'),
                    _p(
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('Fixture sheets or team sheets can be viewed where available.'),
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _subHeading('Process'),
                    _bullet('The member chooses the correct internal fixture type.'),
                    _bullet('The member enters the agreed date and time.'),
                    _bullet('The member books the required rink or rinks.'),
                    _bullet('The member adds the opponent, teammates, marker or umpire if required.'),
                    _bullet('The member who creates the fixture becomes the captain.'),
                    _subHeading('Admin role'),
                    _bullet('Set which internal Fixture Types members are allowed to book.'),
                    _bullet('Check that rink limits and player numbers are sensible.'),
                    _bullet('Monitor bookings if required.'),
                    _bullet('Step in where corrections or cancellations are needed.'),
                    _subHeading('Changes'),
                    _p(
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _bullet('May manage operational details depending on permissions.'),
                    _bullet('Receives important notifications about that fixture.'),
